      ...
      <div className="flex flex-col gap-2">
        ...
        {list.map((item, index) => (
          <div
            ...
            key={index}
          >
            <div className="w12 h-12 md:w-20 md:h-20">
              <img
            ...
            <p
              ...
              className="text-white text-center cursor-pointer text-xs bg-red-600 w-4 md:w-auto md:bg-transparent md:text-black"
            >
              X
            </p>
          </div>
