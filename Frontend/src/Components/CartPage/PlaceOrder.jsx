    ...
    <div className='w-full min-h-screen pt-24 px-2 md:flex md:justify-between lg:gap-2 lg:pt-32 lg:px-10 xl:px-32'>
      ...
      <div className='mb-10 md:w-80 lg:w-[30rem]'>
        ...
        <form className='space-y-2 font-bellefair lg:space-y-5'>
          ...
          <input className='w-full h-10 border border-black/20 outline-none text-[0.8rem] pl-2' value={formData.phone} onChange={handleInputChange} name="phone" type="number" placeholder='Phone' required autoComplete='off' />
        </form>
      </div>
