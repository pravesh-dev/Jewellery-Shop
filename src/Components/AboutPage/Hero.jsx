...
function Hero() {
  return (
    <div className='w-full mx-auto font-bellefair pt-20 pb-5 lg:pt-28 px-2 flex flex-col gap-10 justify-center sm:flex-row lg:px-28 xl:w-[72rem] xl:px-0 xl:pt-44 xl:pb-10'>
      <div className='flex items-center justify-center gap-4 sm:w-[30%] sm:flex-col border border-green-700 sm:gap-2 sm:justify-start sm:pt-14 lg:items-start xl:gap-1'>
