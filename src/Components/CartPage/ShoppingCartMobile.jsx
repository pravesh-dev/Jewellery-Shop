            ...
            <div className="grid grid-cols-7 mb-5">
              ...
              <div className="col-span-4">
                <div className="grid grid-cols-3 gap-2 font-lora">
                  <h3 className="text-[0.7rem] text-dark text-center">Quantity</h3>
            ...
            return (
              <div key={product.id} className="mb-5 grid grid-cols-7">
                <div className="col-span-3 flex items-start flex-col gap-1">
                  ...
                  <div className="font-bellefair pt-2">
                    <h1 className="text-[0.9rem] leading-4">{product.name}</h1>
                    <h3 className="font-Cormorant text-primary text-[0.7rem] italic">In stock</h3>
                    {product.onSale && (
                      <p>
                        <span className="font-lora text-[0.6rem] py-[0.1rem] mr-1 px-1 rounded-[0.23rem] text-accent bg-[#ff0000]">
                          {product.discount}% Off
                        </span>
                        <span className="font-bellefair text-dark text-[0.63rem]">Limited Time Deal</span>
                      </p>
                    )}
                ...
                <div className="col-span-4 h-[6.8rem] grid content-start pt-5 grid-cols-3 gap-2">
                  ...
                  <h3 className="font-bellefair text-center text-[0.8rem]">{currency} {totalPrice}</h3>
                </div>
              </div>
            );
          })}
