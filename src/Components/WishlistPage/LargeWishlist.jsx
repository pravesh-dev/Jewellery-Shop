  ...
  return (
    <div className='w-full min-h-screen mt-3'>
      <div className='grid grid-cols-3 bg-red-300'>
        <div className='col-span-1 border-2 border-emerald-500 space-y-3'>
            <h2 className='text-[0.75rem] lg:text-[1.12rem] font-lora'>Product Details</h2>
            <div className='flex items-start gap-2'>
                <div className='w-[7.6rem] h-[6.8rem] lg:w-[12rem] lg:h-[10.9rem] rounded-[5px] overflow-hidden'>
                ...
                <div className='font-bellefair pt-5'>
                    <h1 className='text-[1rem] lg:text-[1.5rem]'>{product.name}</h1>
                    <div>
        ...
        <div className='col-span-1 border-2 border-emerald-500 space-y-2'>
            <div className='grid grid-cols-3 gap-2 font-lora'>
                <h3 className='text-[0.75rem] text-center'>Deal</h3>
                <h3 className='text-[0.75rem] text-center'>Price</h3>
                <h3 className='text-[0.75rem] text-center'>Stock Status</h3>
            </div>
        ...
        <div className='col-span-1 flex items-center border-2 border-emerald-500'>
